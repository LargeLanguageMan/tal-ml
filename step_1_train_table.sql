CREATE OR REPLACE TABLE `ga4bqml.train_table` as
...
demographics AS (
  ...
  AND _TABLE_SUFFIX >= '20250531'

),

behavioural as(
SELECT
--this is the events (calling parameters from table below)
  user_pseudo_id,
